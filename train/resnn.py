...
def prepare_data():
    ...
    data = RawData()
    data.load_data(path_train="../data/raw_data/round1_ijcai_18_train_20180301.zip", path_test="../data/raw_data/round1_ijcai_18_test_a_20180301.zip")
    dense_trn, dense_val, dense_tst = data.get_split_X(data.get_dense_feats(with_ndprior=True))
    d = Data(with_labels=True, with_dense=True, with_saprse=True, with_train=True, with_valid=True, with_test=True)

    d.load_data(dense_path_train=dense_trn,
                dense_path_valid=dense_val,
                dense_path_test=dense_tst,
                # dense_path_train="../data/prep/24/train/dense.npy",
